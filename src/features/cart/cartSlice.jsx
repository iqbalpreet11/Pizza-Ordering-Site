...
const cartSlice = createSlice({
    ...
    reducers: {
       addItem(state,action) {
        //payload = newItem,payload is going to be what we pass in action creator when we dispatch action
...
//these are selector functions, we can also use slector library in bif projects
